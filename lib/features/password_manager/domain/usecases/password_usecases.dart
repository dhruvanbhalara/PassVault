...
class GetPasswordsUseCase {
  ...
  Future<List<PasswordEntry>> call() => _repository.getPasswords();
}
...
class SavePasswordUseCase {
  ...
  Future<void> call(PasswordEntry entry) => _repository.savePassword(entry);
}
...
class DeletePasswordUseCase {
  ...
  Future<void> call(String id) => _repository.deletePassword(id);
}
